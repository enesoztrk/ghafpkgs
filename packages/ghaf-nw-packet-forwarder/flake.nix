      ...
      with pkgs;
      {
        ...
        checks = {
          inherit
            ...
            ;
          # Run:
          # nix build .#checks.x86_64-linux.integrationDdosTest
          # To run interactively:
          # nix build .#checks.x86_64-linux.integrationDdosTest.driverInteractive
          ...
          integrationTest = pkgs.nixosTest (
            import ./test/integration/packet_gen_tests.nix {
              inherit pkgs;
              inherit crane;
            }
          );
